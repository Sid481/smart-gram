document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!financeGrid || !yearFilter || !monthFilter || !categoryFilter) {
    // Required elements not found; safely exit
    return;
  }

  // 🧩 Example static data (backend can replace this)
  const financeData = [
    {
      src: "uploads/finance/annual-report-2025.pdf",
      type: "pdf",
      title: "Annual Report Jan 2025",
      year: "2025",
      month: "january",
    ...
    },
    {
      ...
      type: "image",
      title: "Expenditure Chart May 2025",
      year: "2025",
      month: "may",
